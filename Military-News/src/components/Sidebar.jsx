...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        { name: 'Mission Schedule', path: '/schedule', icon: <CalendarDays size={20} /> },
        ...
        { name: 'Personnel Directory', path: '/directory', icon: <BookUser size={20} /> },
    ];
        ...
        <div className="h-full flex flex-col bg-military-900 border-r border-military-700 transition-colors duration-300">
            ...
            <div className="p-4 border-t border-military-700">
                <div
                    ...
                    onClick={() => user?.email === 'anmol6@gmail.com' && user?.password === '123456' && navigate('/current-status')}
                >
                    <div className="absolute top-0 right-0 p-1">
                        <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
                    </div>
                    <p className="text-xs font-mono opacity-80 uppercase">Current Status</p>
                    <p className="text-sm font-bold font-stencil uppercase text-red-500">DEFCON 3</p>
                </div>
            </div>
        </div>
    );
